...
$to = $email; 
  ...
  Dear: $fname";
	$email_body = "Thank you. Your registration has been secussfull".
	" Here are the details of the registration form:\n First Name: $fname \n Last Name: $lname \n E-mail: $email \n Roll Number: $roll \n Contact: $contact \n Intrested Parivartan Part: $part \n \n".
"Your these above information will further \n".
...
"Please subuit your regstration fee(Rs:30) to Aayush Verma (e-mail-aayush@iitj.ac.in,Contact:8003259958)\n".
"Thanks \n".
" Regards\n".
"Parivartan Team \n".
"IIT Rajastnan \n".
